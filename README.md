...
👉 **[Install AlloCiné Rating on Trakt](https://github.com/noeRls/trackt-allocine-rating/releases/latest/download/allocine-rating-on-trakt.user.js)**

*Your script manager will prompt you to confirm installation. Automatic updates are enabled by default.*

---

## 📸 Screenshots

### Movie Page (Inception)
![Inception Movie Page](./screenshots/movie_inception.png)

### TV Show Page (Breaking Bad)
![Breaking Bad TV Show Page](./screenshots/show_breaking_bad.png)

---

## ✨ Features

- 🍿 **Press & Spectator Scores**: View both AlloCiné **Presse** and **Public** ratings side-by-side on Trakt media pages.
